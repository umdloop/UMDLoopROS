...
def generate_launch_description():
    ...
    package_dir = get_package_share_directory('2000-SimplifiedAssembly-06')
    ...
    declare_urdf_cmd = DeclareLaunchArgument(
        'urdf_file',
        default_value=os.path.join(package_dir, 'urdf', 'ros2_drive_urdf.xacro'),
    ...
    start_robot_state_publisher_cmd = Node(
        ...
        parameters=[{
            'robot_description': open(os.path.join(package_dir, 'urdf', 'ros2_drive_urdf.xacro')).read()}])
