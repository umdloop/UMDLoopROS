#ifndef DRIVE_HW__DRIVE_HW_HPP_
#define DRIVE_HW__DRIVE_HW_HPP_


#include "drive_hw/visibility_control.h"
#include <memory>
#include <string>
#include <vector>
...
namespace drive_hw
{
  ...
  class DriveHw : public hardware_interface::SystemInterface
  {
  public:
